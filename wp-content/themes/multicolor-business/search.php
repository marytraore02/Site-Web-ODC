...
<div class="container">
	...
	<header role="banner" class="page-header">
		<?php if ( have_posts() ) : ?>
			<h1 class="search-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Search Results for: %s','multicolor-business'), '<span>' . esc_html( get_search_query() ) . '</span>' ); ?></h1>
		<?php else : ?>
			<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'multicolor-business' ); ?></h1>
		<?php endif; ?>
	</header>
	...
	<div class="content-area">
		<main id="main" class="site-main" role="main">
			<?php
			    $layout_option = get_theme_mod( 'multicolor_business_theme_options',__( 'Right Sidebar','multicolor-business' ) );
				        ...
				        <div id="" class="content_area col-lg-8 col-md-8">
					    	<section id="post_section">
								...
								if ( have_posts() ) :
									...
									<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'multicolor-business' ); ?></p>
									<?php
										get_search_form();
			...
			<?php }else if($layout_option == 'Three Columns'){ ?>	
					<div class="row">
						...
						<div id="sidebar" class="col-lg-3 col-lg-3"><?php dynamic_sidebar('sidebar-2'); ?>						
						</div>
					</div>
