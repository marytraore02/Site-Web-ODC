  ...
  <div class="article_content">   
    <div class="article-text">
      ...
      <div class="metabox"> 
        ...
        <i class="fas fa-user"></i><span class="entry-author"><?php esc_html(the_author()); ?></span><span>|</span>
        <i class="fas fa-comments"></i><span class="entry-comments"><?php comments_number( __('0 Comments','multicolor-business'), __('0 Comments','multicolor-business'), __('% Comments','multicolor-business') ); ?></span>
      </div>
